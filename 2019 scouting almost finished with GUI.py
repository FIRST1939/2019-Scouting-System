...
reachLvl1.grid(row=1, column=1, pady=17)
...
reachLvl3.grid(row=3, column=1, pady=17)
...
TeleCargoHRocketCargolbl.grid(column=4, row=1, pady=17)
...
TeleCargoMRocketCargolbl.grid(column=4, row=2, pady=17)
...
TeleCargoLRocketCargolbl.grid(column=4, row=3, pady=17)
...
teleCargoHatchP = Button(tele, text='+', command=teleCargoHatchP1, bg='green4', anchor=W)
teleCargoHatchM = Button(tele, text='-', command=teleCargoHatchM1, bg='red4')
teleCargoHatch.grid(column=2, row=0)
teleCargoHatchP.grid(column=3, row=0, padx=80, sticky=W)
...
teleCargoCargolbl.grid(column=4, row=0, pady=17)
...
nameLBL.grid(column=0, row=0, pady=17)
...
commentsLBL.grid(column=0, row=3, pady=21)
LBL = Label(postMatch, text=' ')
LBL.grid(row=4, column=3, pady=20)
...
sendBTN.grid(row=5, column=1, pady=20, ipadx=80)
