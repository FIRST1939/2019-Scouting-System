...
dangerousSSDriving.grid(row=5, column =0)
...
attemptDeployedRamps.grid(row=4, column=0)
...
groundPickup.grid(row=2, column=0)
...
hatchLeft.grid(row=4, column=0)

startPosLBL = Label(preMatch, text='Where Did they Start?')
startPosLBL.grid(column=0, row=1)
...
SSCargoHatchP = Button(sandstorm, text='+', command=SSCargoHatchP1, bg='green3')
SSCargoHatchM = Button(sandstorm, text='-', command=SSCargoHatchM1, bg='red4')
SSCargoHatch.grid(column=2, row=1)
...
SSCargoCargoP = Button(sandstorm, text='+', command=SSCargoCargoP1, bg='green3')
...
SSCargoSSHRocketHatchP = Button(sandstorm, text='+', command=SSCargoSSHRocketHatchP1, bg='green3')
SSCargoSSHRocketHatchM = Button(sandstorm, text='-', command=SSCargoSSHRocketHatchM1, bg='red4')
SSCargoSSHRocketHatch.grid(column=2, row=2)
...
SSCargoSSMRocketHatchP = Button(sandstorm, text='+', command=SSCargoSSMRocketHatchP1, bg='green3')
SSCargoSSMRocketHatchM = Button(sandstorm, text='-', command=SSCargoSSMRocketHatchM1, bg='red4')
SSCargoSSMRocketHatch.grid(column=2, row=3)
...
SSCargoSSLRocketHatchP = Button(sandstorm, text='+', command=SSCargoSSLRocketHatchP1, bg='green3')
SSCargoSSLRocketHatchM = Button(sandstorm, text='-', command=SSCargoSSLRocketHatchM1, bg='red4')
SSCargoSSLRocketHatch.grid(column=2, row=4)
...
SSCargoSSLRocketCargoP = Button(sandstorm, text='+', command=SSCargoSSLRocketCargoP1, bg='green3')
...
SSCargoSSLRocketCargolbl.grid(column=4, row=4)
...
SSCargoSSMRocketCargoP = Button(sandstorm, text='+', command=SSCargoSSMRocketCargoP1, bg='green3')
...
SSCargoSSHRocketCargoP = Button(sandstorm, text='+', command=SSCargoSSHRocketCargoP1, bg='green3')
...
TeleCargoHRocketCargoP = Button(tele, text='+', command=TeleCargoHRocketCargoP1, bg='green3')
...
TeleCargoHRocketCargolbl.grid(column=4, row=1)
...
TeleCargoMRocketCargoP = Button(tele, text='+', command=TeleCargoMRocketCargoP1, bg='green3')
...
TeleCargoMRocketCargolbl.grid(column=4, row=2)
...
TeleCargoLRocketCargoP = Button(tele, text='+', command=TeleCargoLRocketCargoP1, bg='green3')
...
TeleCargoLRocketCargolbl.grid(column=4, row=3)
...
TeleHatchHRocketHatchP = Button(tele, text='+', command=TeleHatchHRocketHatchP1, bg='green3')
...
TeleHatchMRocketHatchP = Button(tele, text='+', command=TeleHatchMRocketHatchP1, bg='green3')
...
TeleHatchLRocketHatchP = Button(tele, text='+', command=TeleHatchLRocketHatchP1, bg='green3')
...
teleCargoHatchP = Button(tele, text='+', command=teleCargoHatchP1, bg='green3')
...
teleCargoCargoP = Button(tele, text='+', command=teleCargoCargoP1, bg='green3')
...
teleCargoCargolbl.grid(column=4, row=0)
...
teledropCargoP = Button(tele, text='+', command=teledropCargoP1, bg='green3')
...
teledropHatchP = Button(tele, text='+', command=teledropHatchP1, bg='green3')
...
teledropHatchlbl.grid(column=0, row=4)
...
foulP = Button(tele, text='+', command=foulP1, bg='green3')
...
techFoulP = Button(tele, text='+', command=techFoulP1, bg='green3')
...
comments.grid(column=0, row=4, columnspan=2, rowspan=4)
commentsLBL = Label(postMatch, text='Comments:')
commentsLBL.grid(column=0, row=3)

send = Button(postMatch, text='send', command=reinitscreen)
send.grid(row=10, column=2)
